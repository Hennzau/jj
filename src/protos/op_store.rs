...
pub struct View {
    ...
    #[prost(map = "string, message", tag = "2")]
    pub local_bookmarks: ::std::collections::HashMap<
        ::prost::alloc::string::String,
        RefTarget,
    >,
    #[prost(map = "string, message", tag = "3")]
    pub local_tags: ::std::collections::HashMap<
        ::prost::alloc::string::String,
        RefTarget,
    >,
    #[prost(map = "string, message", tag = "4")]
    pub remote_views: ::std::collections::HashMap<
        ::prost::alloc::string::String,
        RemoteView,
    >,
...
impl RemoteRefState {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::NewUnspecified => "REMOTE_REF_STATE_NEW_UNSPECIFIED",
            Self::Tracked => "REMOTE_REF_STATE_TRACKED",
        }
    }
